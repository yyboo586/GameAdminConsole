...
<script lang="ts">
//说明：大屏需要引入百度地图api,我不想全局在index.html页面引入，但是使用vue render以组件方式引入后，
//报错了：Failed to execute 'write' on 'Document': It isn't possible to write into a document from an
